...
check_trial_posterior_functions <- function(example) {
  with(example, {
    suppressWarnings(suppressMessages(trial <- blrm_trial(histdata, dose_info, drug_info)))
...
check_trial_with_prior_posterior_functions <- function(example) {
  with(example, {
    suppressWarnings(suppressMessages(trial <- blrm_trial(histdata, dose_info, drug_info, simplified_prior = TRUE)))
